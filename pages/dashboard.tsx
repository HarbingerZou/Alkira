...
function PageHeader({ title, user }: PageHeaderProps) {
  const navLink = {
    href: "/profile",
    label: "My Profile",
...
function MessageForm({ newMessage, setNewMessage, isSubmitting, onSubmit }: MessageFormProps) {
  return (
...
function MessagesList({ messages, title, emptyMessage }: MessagesListProps) {
  return (
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <MessagesList 
            ...
            emptyMessage="No messages yet. Be the first to post something!"
          />
        </div>
      </div>
    </div>
